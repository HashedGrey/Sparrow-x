...
PostgreSQL stores business projections, progress events, approval records, and external checkpoints.

## Embabel Agent Reasoning

Embabel performs bounded reasoning inside Temporal Activities.

It classifies intent, creates or revises mission plans, selects authorized capabilities, reviews observations, 
and determines whether the mission requires another execution hop or final synthesis.
...
All external mutations are idempotent, observable, replay-safe and policy-governed.
