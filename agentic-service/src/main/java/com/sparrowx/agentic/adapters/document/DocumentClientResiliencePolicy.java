...
public final class DocumentClientResiliencePolicy {

    private final Map<Operation, Duration> deadlines;

    public DocumentClientResiliencePolicy(Map<Operation, Duration> deadlines) {
    ...
    public DocumentClientException translate(Operation operation, StatusRuntimeException exception) {
        return new DocumentClientException(operation, classify(exception), exception);
    }
    ...
    public static final class DocumentClientException extends RuntimeException {
        ...
        private DocumentClientException(
            ...
            super("document-service " + operation + " failed: " + failure.description(), cause);
